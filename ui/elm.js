	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('is an application to maintain your stock of medicine, take doses, add stock and get reminded when you\'re about to run out. ')
					]))
			]));
};
